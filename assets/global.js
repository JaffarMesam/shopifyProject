...
function initSortBySelection() {
  const sortBySelect = document.querySelector("#SortBy");

  if(sortBySelect) {
    const selectLabel = document.querySelector("[js-select-label]")
...
initSortBySelection();
document.addEventListener('sort-by-selection:init', initSortBySelection);